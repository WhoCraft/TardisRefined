...
public class TRComponents implements WorldComponentInitializer {
    ...
    public static final ComponentKey<TardisLevelOperatorImpl> TARDIS_DATA = ComponentRegistryV3.INSTANCE.getOrCreate(ResourceLocation.tryBuild(TardisRefined.MODID, "tardis_data"), TardisLevelOperatorImpl.class);
