...
public class ProviderConfiguredFeatures {
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> createKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.tryBuild(TardisRefined.MODID, name));
    }
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        ResourceLocation templateLocation = ResourceLocation.tryBuild(TardisRefined.MODID, "cave/tardis_root_cluster_deepslate");
