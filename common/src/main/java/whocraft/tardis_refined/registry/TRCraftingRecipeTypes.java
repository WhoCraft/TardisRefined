...
public class TRCraftingRecipeTypes {
    ...
    public static final RegistrySupplier<RecipeType<ManipulatorCraftingRecipe>> ASTRAL_MANIPULATOR_RECIPE = RECIPE_TYPE_DEFERRED_REGISTRY.register("astral_manipulator_recipe", () -> registerRecipeType(TardisRefined.modLocation( "astral_manipulator_recipe")));
