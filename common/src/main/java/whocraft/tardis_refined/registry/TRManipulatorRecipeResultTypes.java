...
public class TRManipulatorRecipeResultTypes {
    ...
    public static final ResourceKey<Registry<Codec<? extends ManipulatorCraftingResult>>> MANIPULATOR_RECIPE_TYPE_KEY = ResourceKey.createRegistryKey(TardisRefined.modLocation( "manipulator_recipe_result"));
