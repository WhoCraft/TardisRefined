...
public class CoralConsoleModel extends HierarchicalModel implements ConsoleUnit {
    ...
    public static final AnimationDefinition IDLE = Frame.loadAnimation(ResourceLocation.fromNamespaceAndPath(TardisRefined.MODID, "frame/console/coral/idle.json"));
    public static final AnimationDefinition FLIGHT = Frame.loadAnimation(ResourceLocation.fromNamespaceAndPath(TardisRefined.MODID, "frame/console/coral/flight.json"));
