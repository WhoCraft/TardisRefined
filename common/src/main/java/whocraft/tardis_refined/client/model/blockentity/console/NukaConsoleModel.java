...
public class NukaConsoleModel extends HierarchicalModel {
	...
	public NukaConsoleModel(ModelPart root) {
		this.rotor_zminus3_yplus5_rotateY = root.getChild("rotor");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rotor_zminus3_yplus5_rotateY = partdefinition.addOrReplaceChild("rotor", CubeListBuilder.create().texOffs(62, 23).addBox(-5.0F, -22.0F, -8.0F, 10.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 16.0F, 0.0F));
		...
		PartDefinition bone67 = bone85.addOrReplaceChild("bone67", CubeListBuilder.create().texOffs(0, 33).addBox(-3.0F, -10.0F, -9.175F, 6.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -23.0F, 0.0F));
		...
		PartDefinition bone61 = bone85.addOrReplaceChild("bone61", CubeListBuilder.create().texOffs(19, 55).addBox(-2.0F, -11.0F, -9.5F, 4.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -22.5F, 0.0F, 0.0F, -0.5236F, 0.0F));
		...
		PartDefinition bone43 = bone85.addOrReplaceChild("bone43", CubeListBuilder.create().texOffs(61, 63).addBox(-3.0F, -23.0F, -7.0F, 6.0F, 15.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -8.0F, 0.0F));
		...
		PartDefinition bone37 = bone85.addOrReplaceChild("bone37", CubeListBuilder.create().texOffs(19, 75).addBox(-1.0F, -23.0F, -8.0F, 2.0F, 15.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, 0.0F, 0.0F, -0.5236F, 0.0F));
