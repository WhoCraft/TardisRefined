...
public class MystConsoleModel extends HierarchicalModel implements ConsoleUnit {
    ...
    private static final ResourceLocation MYST_TEXTURE = ResourceLocation.fromNamespaceAndPath(TardisRefined.MODID, "textures/blockentity/console/myst/myst_console.png");
