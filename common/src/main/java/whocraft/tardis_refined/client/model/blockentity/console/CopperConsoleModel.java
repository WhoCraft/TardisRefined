...
public class CopperConsoleModel extends HierarchicalModel implements ConsoleUnit {
	...
	public static final AnimationDefinition COPPER_FLIGHT_LOOP = AnimationDefinition.Builder.withLength(6f).looping()
			...
			.addAnimation("bone193",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							...
							new Keyframe(2.28f, KeyframeAnimations.degreeVec(0f, -21.93f, 0f),
									AnimationChannel.Interpolations.LINEAR),
							new Keyframe(2.32f, KeyframeAnimations.degreeVec(0f, 92.26f, 0f),
									AnimationChannel.Interpolations.LINEAR),
			...
			.addAnimation("bone194",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							...
							new Keyframe(1f, KeyframeAnimations.degreeVec(
									0f, 104.5f, 0f),
									AnimationChannel.Interpolations.LINEAR),
							new Keyframe(2.2f, KeyframeAnimations.degreeVec(0f, 164.07f, 0f),
									AnimationChannel.Interpolations.LINEAR),
			...
			.addAnimation("bone160",
					new AnimationChannel(AnimationChannel.Targets.SCALE,
							...
							new Keyframe(2.08f, KeyframeAnimations.scaleVec(1f, 1.04f, 1f),
									AnimationChannel.Interpolations.LINEAR),
							new Keyframe(2.6f, KeyframeAnimations.scaleVec(1f, 0.97f, 1f),
									AnimationChannel.Interpolations.LINEAR),
			...
			.addAnimation("bone168",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							...
							new Keyframe(1.92f, KeyframeAnimations.degreeVec(-23.38f, 0f, 0f),
									AnimationChannel.Interpolations.LINEAR),
							new Keyframe(2.12f, KeyframeAnimations.degreeVec(-37.85f, 0f, 0f),
									AnimationChannel.Interpolations.LINEAR),
			...
			.addAnimation("spinthingP2_control",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							...
							new Keyframe(1.96f, KeyframeAnimations.degreeVec(-45f,
									0f, 0f),
									AnimationChannel.Interpolations.LINEAR),
							new Keyframe(2.36f, KeyframeAnimations.degreeVec(3.4f, 0f, 0f),
									AnimationChannel.Interpolations.LINEAR),
    ...
    public static final AnimationDefinition COPPER_ANIMATION = AnimationDefinition.Builder.withLength(6f).looping()
            .addAnimation("bone312",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            new Keyframe(0f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
