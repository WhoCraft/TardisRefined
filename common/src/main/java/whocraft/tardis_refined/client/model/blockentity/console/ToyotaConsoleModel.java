...
public class ToyotaConsoleModel extends HierarchicalModel implements ConsoleUnit {
	...
	public static final AnimationDefinition MODEL_NEW = AnimationDefinition.Builder.withLength(6f).looping()
			...
			.addAnimation("bone191",
					new AnimationChannel(AnimationChannel.Targets.ROTATION,
							new Keyframe(0.4f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
									AnimationChannel.Interpolations.CATMULLROM),
							new Keyframe(0.76f, KeyframeAnimations.degreeVec(0f, 6.26f, 0f),
									AnimationChannel.Interpolations.CATMULLROM),
							new Keyframe(1.16f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
									AnimationChannel.Interpolations.CATMULLROM),
							new Keyframe(2.12f, KeyframeAnimations.degreeVec(0f, 3.5f, 0f),
									AnimationChannel.Interpolations.CATMULLROM),
							new Keyframe(2.6f, KeyframeAnimations.degreeVec(0f, -8f, 0f),
									AnimationChannel.Interpolations.LINEAR),
			...
			.addAnimation("bone195",
					new AnimationChannel(AnimationChannel.Targets.SCALE,
							new Keyframe(0f, KeyframeAnimations.scaleVec(1f, 1f, 1f),
									AnimationChannel.Interpolations.LINEAR),
							new Keyframe(0.92f, KeyframeAnimations.scaleVec(1f, 1.54f, 1f),
									AnimationChannel.Interpolations.LINEAR),
							...
							new Keyframe(3.08f, KeyframeAnimations.scaleVec(1f, 1f, 1f),
									AnimationChannel.Interpolations.LINEAR),
							new Keyframe(4.28f, KeyframeAnimations.scaleVec(1f, 1.5f, 1f),
									AnimationChannel.Interpolations.LINEAR),
	...
	public void renderConsole(GlobalConsoleBlockEntity globalConsoleBlock, Level level, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		...
		if(globalConsoleBlock != null) {
			this.animate(globalConsoleBlock.liveliness, MODEL_NEW, Minecraft.getInstance().player.tickCount);
		}
