...
public class MonitorOS extends Screen {
    ...
    public static ResourceLocation FRAME = ResourceLocation.fromNamespaceAndPath(TardisRefined.MODID, "textures/gui/monitor/frame_brass.png");
    ...
    public static ResourceLocation NOISE = ResourceLocation.fromNamespaceAndPath(TardisRefined.MODID, "textures/gui/monitor/noise.png");
    public static ResourceLocation SYMBLS = ResourceLocation.fromNamespaceAndPath(TardisRefined.MODID, "textures/gui/monitor/gallifreyan_symbols.png");
