...
public class CancelDesktopScreen extends Screen {
    ...
    public void render(PoseStack poseStack, int i, int j, float f) {
        ...
        blit(poseStack, width / 2 - minecraft.font.width(Component.translatable(ModMessages.UI_DESKTOP_CANCEL_TITLE)) + 45, 25, 0, 0, 9, 9, 32, 32);
        blit(poseStack, width / 2 + minecraft.font.width(Component.translatable(ModMessages.UI_DESKTOP_CANCEL_TITLE)) - 55, 25, 0, 0, 9, 9, 32, 32);
