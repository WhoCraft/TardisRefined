...
public class MonitorScreen extends Screen {
    ...
    public void render(PoseStack poseStack, int i, int j, float f) {
        ...
        ScreenHelper.renderWidthScaledText(Component.translatable("tardis_refined.monitor.main.gps").getString() + ":", poseStack, Minecraft.getInstance().font, 25, minGPSY - 30, Color.WHITE.getRGB(), 75, false);
        ...
        ScreenHelper.renderWidthScaledText( Component.translatable("tardis_refined.monitor.main.destination").getString() + ":", poseStack, Minecraft.getInstance().font, 25, minGPSDestY - 30, Color.WHITE.getRGB(), 75, false);
        ...
        ScreenHelper.renderWidthScaledText(Component.translatable("tardis_refined.monitor.main_title").getString(), poseStack, Minecraft.getInstance().font, width / 2, 25, Color.LIGHT_GRAY.getRGB(), 300, true);
