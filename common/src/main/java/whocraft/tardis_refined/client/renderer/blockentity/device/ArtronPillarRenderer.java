...
public class ArtronPillarRenderer implements BlockEntityRenderer<ArtronPillarBlockEntity>, BlockEntityRendererProvider<ArtronPillarBlockEntity> {
    ...
    private final ResourceLocation POWER_ON = TardisRefined.modLocation( "textures/blockentity/artron_pillar.png");
    private final ResourceLocation POWER_OFF = TardisRefined.modLocation( "textures/blockentity/artron_pillar_off.png");
    ...
    private static void vertex2(VertexConsumer iVertexBuilder, Matrix4f matrix4f, float p_229060_2_, float p_229060_3_) {
        iVertexBuilder.addVertex(matrix4f, -HALF_SQRT_3 * p_229060_3_, p_229060_2_, -0.5F * p_229060_3_).setColor(16, 206, 0, 0).endVertex();
    }

    private static void vertex3(VertexConsumer iVertexBuilder, Matrix4f matrix4f, float p_229062_2_, float p_229062_3_) {
        iVertexBuilder.addVertex(matrix4f, HALF_SQRT_3 * p_229062_3_, p_229062_2_, -0.5F * p_229062_3_).setColor(16, 206, 0, 0).endVertex();
    }

    private static void vertex4(VertexConsumer iVertexBuilder, Matrix4f matrix4f, float p_229063_2_, float p_229063_3_) {
        iVertexBuilder.addVertex(matrix4f, 0.0F, p_229063_2_, 1.0F * p_229063_3_).setColor(16, 206, 0, 0).endVertex();
    }
    ...
    public void render(ArtronPillarBlockEntity blockEntity, float f, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, int j) {
        ...
        artronPillarBlockModel.renderToBuffer(poseStack, multiBufferSource.getBuffer(RenderType.entityTranslucent(lampTexture)), i, OverlayTexture.NO_OVERLAY, RenderHelper.getColorInt(1f, 1f, 1f, 1f));
