...
public class TardisRefined {
    ...
    public static void init() {
        ...
        TRManipulatorRecipeResultTypes.RESULT_TYPE_DEFERRED_REGISTRY.registerToModBus();
        TRCraftingRecipeTypes.RECIPE_TYPES.registerToModBus();
        ...
        Upgrades.UPGRADE_DEFERRED_REGISTRY.registerToModBus();
