...
public class CoralConsoleTheme extends ConsoleThemeDetails {
    ...
    public ControlSpecification[] getControlSpecification() {
        return new ControlSpecification[] {
                ...
                new ControlSpecification(ConsoleControl.DIMENSION, new Vector3f(1.1f, 0.39999694f, 0.75f), EntityDimensions.scalable(0.1f, 0.1f)),
                new ControlSpecification(ConsoleControl.FAST_RETURN, new Vector3f(-1.1f, 0.4f, -0.75f), EntityDimensions.scalable(0.1f, 0.1f))
        };
    }
}
