...
public class GenericConsoleSoundProfile extends ConsoleSoundProfile {
    ...
    public GenericConsoleSoundProfile() {
        ...
        setHandbrakeEnable(new ConsoleSound(null, new PitchedSound(SoundEvents.LEVER_CLICK, 0.6f)));
        setHandbrakeDisable(new ConsoleSound(null, new PitchedSound(SoundEvents.LEVER_CLICK, 0.5f)));
