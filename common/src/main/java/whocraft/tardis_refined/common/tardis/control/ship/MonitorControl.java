...
public class MonitorControl extends Control {
    ...
    public boolean onLeftClick(TardisLevelOperator operator, ConsoleTheme theme, ControlEntity controlEntity, Player player) {
        ...
        if(player.getMainHandItem().getItem() instanceof MapItem mapItem){
            ...
            waypoints.addWaypoint(new TardisNavLocation(new BlockPos(mapData.centerX, 0, mapData.centerZ), Direction.NORTH, Level.OVERWORLD), String.valueOf(player.level().random.nextInt(Integer.MAX_VALUE)));
        }
