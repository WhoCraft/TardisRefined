...
public class ToyotaConsoleTheme extends ConsoleThemeDetails {
    ...
    public ControlSpecification[] getControlSpecification() {
        return new ControlSpecification[] {
                ...
                new ControlSpecification(TRControlRegistry.MONITOR, new Vector3f(0.305f, 1.04f, 0.59f), EntityDimensions.scalable(0.39f, 0.24f)),
                new ControlSpecification(TRControlRegistry.DIMENSION, new Vector3f(0.64f, 0.545f, -0.405f), EntityDimensions.scalable(0.35f, 0.2f)),
