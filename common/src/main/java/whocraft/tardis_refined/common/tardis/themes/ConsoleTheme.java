...
public class ConsoleTheme implements Theme {
    ...
    public static final CustomRegistry<ConsoleTheme> CONSOLE_THEME_REGISTRY = CustomRegistry.create(CONSOLE_THEME_REGISTRY_KEY);

    /** Tardis Refined instance of the ConsoleTheme registry. Addon Mods: DO NOT USE THIS, it is only for Tardis Refined use only*/
    public static final DeferredRegistry<ConsoleTheme> CONSOLE_THEME_DEFERRED_REGISTRY = DeferredRegistry.createCustom(TardisRefined.MODID, CONSOLE_THEME_REGISTRY);
