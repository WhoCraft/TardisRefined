...
public class InitiativeConsoleTheme extends ConsoleThemeDetails {
    ...
    public ControlSpecification[] getControlSpecification() {
        return new ControlSpecification[] {
                ...
                new ControlSpecification(ConsoleControl.DIMENSION, new Vector3f(-0.5f, 0.94999695f, -0.2999998f), EntityDimensions.scalable(0.1f, 0.1f)),
                new ControlSpecification(ConsoleControl.FAST_RETURN, new Vector3f(0.05f, 0.8500015f, -0.59999955f), EntityDimensions.scalable(0.1f, 0.1f))
        };
    }
}
