...
public class InitiativeConsoleTheme extends ConsoleThemeDetails {
    ...
    public ControlSpecification[] getControlSpecification() {
        return new ControlSpecification[] {
                ...
                new ControlSpecification(TRControlRegistry.MONITOR, new Vector3f(-0.64f, 1.38f, 0.24f), EntityDimensions.scalable(0.25f, 0.25f)),
                ...
                new ControlSpecification(TRControlRegistry.GENERIC_NO_SHOW, new Vector3f(0.79f, 0.75f, 0.44f), EntityDimensions.scalable(0.12f, 0.12f)),
                ...
                new ControlSpecification(TRControlRegistry.HANDBRAKE, new Vector3f(-1.06f, 0.72f, 0.33f), EntityDimensions.scalable(0.13f, 0.13f)),
