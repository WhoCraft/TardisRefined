...
public abstract class ManipulatorCraftingResult {
    ...
    public static final Codec<ManipulatorCraftingResult> RESULT_CODEC = TRManipulatorRecipeResultTypes.RESULT_TYPE_REGISTRY.getCodec().get().dispatch(ManipulatorCraftingResult::type, Function.identity());
