...
public class TardisHums {
    ...
    public static HumEntry getDefaultHum() {
        ...
        arrayList.add(ResourceLocation.fromNamespaceAndPath(TardisRefined.MODID, "interior_creaks"));
        return new HumEntry(ResourceLocation.fromNamespaceAndPath(TardisRefined.MODID, "coral"), TRSoundRegistry.HUM_CORAL.getId(), arrayList);
    }
