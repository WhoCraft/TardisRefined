...
public class LegacyTardisChunkGeneratorV1_0 extends ChunkGenerator {
    public static final Codec<LegacyTardisChunkGeneratorV1_0> CODEC = RecordCodecBuilder.create(instance -> instance.group(RegistryOps.retrieveElement(ChunkGenerators.TARDIS_BIOME)).apply(instance, instance.stable(LegacyTardisChunkGeneratorV1_0::new)));
    ...
    public LegacyTardisChunkGeneratorV1_0(Holder<Biome> holder) {
    ...
    @Override
    public Codec<LegacyTardisChunkGeneratorV1_0> codec() {
        return CODEC;
    }
