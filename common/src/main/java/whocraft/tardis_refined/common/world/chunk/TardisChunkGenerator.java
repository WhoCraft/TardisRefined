...
public class TardisChunkGenerator extends ChunkGenerator {
    ...
    private static final ResourceLocation EOH_PART_A = new ResourceLocation(TardisRefined.MODID, "rooms/eye_of_harmony_part_a");
    private static final ResourceLocation EOH_PART_B = new ResourceLocation(TardisRefined.MODID, "rooms/eye_of_harmony_part_b");
    private static final ResourceLocation HUB_CENTER = new ResourceLocation(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_center");
    private static final ResourceLocation HUB_SOUTH = new ResourceLocation(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_south");
    private static final ResourceLocation HUB_SOUTH_EAST = new ResourceLocation(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_south_east");
    private static final ResourceLocation HUB_EAST = new ResourceLocation(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_east");
    private static final ResourceLocation HUB_NORTH_EAST = new ResourceLocation(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_north_east");
    private static final ResourceLocation HUB_NORTH = new ResourceLocation(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_north");
    private static final ResourceLocation HUB_WEST = new ResourceLocation(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_west");
