...
public class TardisChunkGenerator extends ChunkGenerator {
    ...
    public void applyBiomeDecoration(WorldGenLevel pLevel, ChunkAccess pChunk, StructureManager pStructureManager) {
        ...
        if (pChunk.getPos().x == 63 && pChunk.getPos().z == 2) {
            pLevel.getLevel().getStructureManager().get(ResourceLocation.tryBuild(TardisRefined.MODID, "rooms/eye_of_harmony_part_a")).ifPresent(structure -> {
        ...
        if (pChunk.getPos().x == 63 && pChunk.getPos().z == 4) {
            pLevel.getLevel().getStructureManager().get(ResourceLocation.tryBuild(TardisRefined.MODID, "rooms/eye_of_harmony_part_b")).ifPresent(structure -> {
        ...
        if (pChunk.getPos().x == 63 && pChunk.getPos().z == 0) {
            pLevel.getLevel().getStructureManager().get(ResourceLocation.tryBuild(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_center")).ifPresent(structure -> {
                int height = 76;
        ...
        if (pChunk.getPos().x == 63 && pChunk.getPos().z == 3) {
            placePieceInWorld(pLevel, ResourceLocation.tryBuild(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_south"), pChunk, false);
            ResourceLocation pieceToPlace = getRandomCorridorPiece().getResourceLocation();
            placePieceInWorld(pLevel, pieceToPlace, pChunk, true);
            return;
        }
        if (pChunk.getPos().x == 66 && pChunk.getPos().z == 3) {
            placePieceInWorld(pLevel, ResourceLocation.tryBuild(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_south_east"), pChunk, false);
            ResourceLocation pieceToPlace = getRandomCorridorPiece().getResourceLocation();
            placePieceInWorld(pLevel, pieceToPlace, pChunk, true);
            return;
        }
        ...
        if (pChunk.getPos().x == 66 && pChunk.getPos().z == 0) {
            placePieceInWorld(pLevel, ResourceLocation.tryBuild(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_east"), pChunk, false);
            ResourceLocation pieceToPlace = getRandomCorridorPiece().getResourceLocation();
            placePieceInWorld(pLevel, pieceToPlace, pChunk, true);
            return;
        }
        if (pChunk.getPos().x == 66 && pChunk.getPos().z == -3) {
            placePieceInWorld(pLevel, ResourceLocation.tryBuild(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_north_east"), pChunk, false);
            ResourceLocation pieceToPlace = getRandomCorridorPiece().getResourceLocation();
            placePieceInWorld(pLevel, pieceToPlace, pChunk, true);
            return;
        }
        ...
        if (pChunk.getPos().x == 63 && pChunk.getPos().z == -3) {
            placePieceInWorld(pLevel, ResourceLocation.tryBuild(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_north"), pChunk, false);
            ResourceLocation pieceToPlace = getRandomCorridorPiece().getResourceLocation();
            placePieceInWorld(pLevel, pieceToPlace, pChunk, true);
            return;
        }
        ...
        if (pChunk.getPos().x == 60 && pChunk.getPos().z == 0) {
            placePieceInWorld(pLevel, ResourceLocation.tryBuild(TardisRefined.MODID, "corridors/corridor_hub/corridor_hub_west"), pChunk, false);
            ResourceLocation pieceToPlace = getRandomCorridorPiece().getResourceLocation();
            placePieceInWorld(pLevel, pieceToPlace, pChunk, true);
            return;
        }
        ...
        if (pChunk.getPos().x % arsChunkSize == 0 && pChunk.getPos().z % arsChunkSize == 0) {
            ...
            if (isChunkAtGravityInterval(pChunk.getPos())) {
                ResourceLocation pieceToPlace = ResourceLocation.tryBuild(TardisRefined.MODID, "corridors/corridor_connection_bottom");
                placePieceInWorld(pLevel, pieceToPlace, pChunk, false);

                pieceToPlace = ResourceLocation.tryBuild(TardisRefined.MODID, "corridors/corridor_connection_top");
                placePieceInWorld(pLevel, pieceToPlace, pChunk, true);
