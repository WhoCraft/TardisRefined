...
public class ModMessages {
    ...
    public static final String CONFIG_IP_SUBLEVEL_COLLISION = config("immersive_portals_sublevel_collision");
    public static final String CONFIG_IP_TELEPORTATION = config("immersive_portals_teleportation_mode");
    public static final String CONFIG_IP_TELEPORTATION_SUBLEVELS = config("immersive_portals_teleportation_mode_sublevels");
