...
public class TRDamageTypeTagProvider extends DamageTypeTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        this.tag(DamageTypeTags.NO_KNOCKBACK).add(TRDamageSources.CHOKE, TRDamageSources.EYE_OF_HARMONY);
        this.tag(DamageTypeTags.BYPASSES_WOLF_ARMOR).add(TRDamageSources.CHOKE);
    }
